...
```bash
http://location-service-international.dil1.opentry.me
```
...
```bash
curl -X POST http://threescale-automate-international.dil1.opentry.me/threescale/automate/{YOUR_API_TOKEN}/{USERX}/{OPENSHIFT_APP_URL}
```

For example: 

```bash
curl -X POST http://threescale-automate-international.dil1.opentry.me/threescale/automate/829405ec3d2dd0f91aa8435347827135c323c69757dd2dfb49ed41aa8ceb13ef/user26/dil1.opentry.me
```
