 ...
 ** http://microcks.github.io/documentation/automating/jenkins/[Jenkins Plugin]
 ** http://microcks.github.io/documentation/installing/openshift/[Installing on OpenShift]
