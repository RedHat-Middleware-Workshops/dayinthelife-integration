...
. Use your unique username as your workspace name e.g. {user-username}.  Select "day in the life workshop" stack, increase the RAM to 4GB and then click *Create*.
+
image::images/00-new-workspace.png[00-new-workspace.png, role="integr8ly-img-responsive"]

. Click on **Create & Open**.
+
image::images/00-open-workspace.png[00-open-workspace.png, role="integr8ly-img-responsive"]
...
. Click on `Red Hat Openshift`
+
image::images/000-open-openshift.png[000-open-openshift.png, role="integr8ly-img-responsive"]
...
. In CodeReady Workspaces, click on Workspace > Import Project from the main menu.  A pop-up will appear.
+
...
. Click the **+** button next to the *Build* folder, then select *Maven*
+
...
. To run the script,we need to login to OpenShift via the Terminal.  Navigate back to the OpenShift web UI and click the **Copy Login Command** link.  If you aren't logged-in to OpenShift, open a new tab and navigate to `https://master.{openshift_url}/console`.
+
image::images/00-location-list.png[00-login-ocp-cli.png, role="integr8ly-img-responsive"]

. Navigate back to CodeReady Workspaces, open the terminal, and paste the login command from your clipboard.  Once you've logged-in, select the OpenShift project you created earlier using `oc project userX` (replacing userX with your username).
+
image::images/00-location-list.png[00-login-terminal.png, role="integr8ly-img-responsive"]
...
+
image::images/00-verify-location-service[00-verify-location-service, role="integr8ly-img-responsive"]
