...
+
image::images/00-create-workspace.png[00-create-workspace.png, role="integr8ly-img-responsive"]
...
. Click on `Redhat Openshift`
+
image::images/000-open-openshift.png[000-open-openshift.png, role="integr8ly-img-responsive"]

. Click on your unique namespace to enter your workspace e.g. `{user-username}`.
+
...
----
+
image::images/00-terminal.png[00-terminal.png, role="integr8ly-img-responsive"]
...
+
image::images/00-login-ocp-cli.png[00-location-list.png, role="integr8ly-img-responsive"]

. Navigate back to Eclipse Che, open the terminal, and paste the login command from your clipboard.  Once you've logged-in, select the OpenShift project you created earlier using `oc project {user-username}`
+
image::images/00-login-terminal.png[00-location-list.png, role="integr8ly-img-responsive"]
