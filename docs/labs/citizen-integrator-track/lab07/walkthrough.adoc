:walkthrough: Fuse Online & 3Scale Smart Discovery Bonus Lab
...
. Open your link:{fuse-url}[Fuse Online Console, window="_blank"]. Navigate to your project's overview page. It will be called `{user-username} Project`.
