...
:microcks-url: http://microcks.apps.apiday-3ee2.openshiftworkshop.com
...
. Log in to link:{microcks-url}[Apicurio Studio, window="_blank"] web console using `{user-username}` and password: `{user-password}`.
+
