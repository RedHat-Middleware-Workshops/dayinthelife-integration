...
.Apicurio
****
* link:http://apicurio-studio.apps.apiday-3ee2.openshiftworkshop.com[Apicurio Studio, window="_blank"]
****
...
. Log in to link:http://apicurio-studio.apps.apiday-3ee2.openshiftworkshop.com[Apicurio Studio, window="_blank"] web console using `{user-username}` and password: `{user-password}`.
+
