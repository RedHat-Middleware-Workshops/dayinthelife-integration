...
.Apicurio Studio
****
* link:{apicurio-url}[Web Application, window="_blank"]
****
...
. Log in to link:{apicurio-url}[Apicurio Studio, window="_blank"] web console using user:{user-username} and password: openshift.
+
