...
. Click on **INTEGRATE THIS PRODUCT**  link for the Location API.
+
image::images/3scale-location-integrate.png[integrate-api-link, role="integr8ly-img-responsive"]
...
3scale-location-app-plan-publish.png
