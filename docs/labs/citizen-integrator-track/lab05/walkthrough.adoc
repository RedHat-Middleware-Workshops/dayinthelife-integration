...
. Change all the code *Echo* references in the homepage code for *Office Locations*, using your browsers Find+Replace functionality.  Don't bother changing the echo URL's though.
