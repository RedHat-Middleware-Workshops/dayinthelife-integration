...
. Choose *API Provider*
+
image::images/n02-api-provider.png[02-api-provider.png]

. Select *Create from scratch*

image::images/n03-api-from-scratch.png[n03-api-from-scratch]
...
image::images/n20-integration-name.png[n20-integration-name]

. Click on Add Location operation.

image::images/n21-choose-operation.png[n21-choose-operation]
...
image::images/n22-add-db-connection.png[n22-add-db-connection]

. Click on `LocationDB` from the catalog and then select `Invoke SQL`

image::images/n24-invoke-sql.png[n24-invoke-sql]
...
image::images/n25-sql-statement.png[n25-sql-statement.png]
...
image::images/n28-data-map-db.png[n28-data-map-db.png]
...
image::images/n31-data-map-response.png[n31-data-map-response]

. Click *Publish* on the next screen.

image::images/n32-publish.png[n32-publish]
